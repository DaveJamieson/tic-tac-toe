...
function Header({ player, handleReset, handlePlayAgain, gameWon }) {
  return (
    <div className="w-full min-h-40 flex flex-col items-center p-10">
      <h1 className="text-6xl font-semibold p-2 mb-16">TIC TAC TOE</h1>
      <div className="flex flex-row gap-10">
        {!gameWon && (
          <h2 className="text-2xl p-2 border-2 border-slate-400 rounded-lg bg-gradient-to-tr from-purple-400 via-pink-500 to-red-500">
